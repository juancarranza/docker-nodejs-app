#FROM: especifica la imagen que estamos utilizando de base, en este caso se es la node, en su version 17.3.0-alpine3.14
...
# COPY se van a copiar los archivos necesarios para nuestra aplicacion en este caso se refiere a la carpeta app de nuestro proyecto(local)
...
#CMD ["node", "app"]
FROM node:17.3.0-alpine3.14 as runtime
WORKDIR /home/node/app
